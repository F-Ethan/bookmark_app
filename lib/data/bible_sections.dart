...
/// Horner's original list order (Lists 1–10 as published).
final List<BibleGroup> hornerBookGroups = [
  BibleGroup(
    name: 'List 1 — Gospels',
    books: [
...
/// Canonical (book-order) grouping.
final List<BibleGroup> orderedBookGroups = [
  BibleGroup(
...
/// Default is Horner's original order.
final List<BibleGroup> defaultBookGroups = hornerBookGroups;
